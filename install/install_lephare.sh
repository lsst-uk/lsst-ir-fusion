...
$LEPHAREDIR/source/sedtolib -c $LEPHARECONFIG -t S -STAR_SED STAR_MOD_ALL.list
...
$LEPHAREDIR/source/zphota -c $LEPHARECONFIG -CAT_IN COSMOS.in -CAT_OUT zphot_short.out -ZPHOTLIB VISTA_COSMOS_FREE,ALLSTAR_COSMOS,QSO_COSMOS  -ADD_EMLINES 0,100 -AUTO_ADAPT YES   -Z_STEP 0.04,0,6
