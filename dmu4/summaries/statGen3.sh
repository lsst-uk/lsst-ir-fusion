...
#find $repo/u/ir-shir1/DRP/vikingSingleFrame/20221130 -name postISRCCD*.fits  | wc -l
#echo "viking calexp singleFrame"
#find $repo/u/ir-shir1/DRP/vikingSingleFrame/20221130 -name calexp*.fits  | wc -l
