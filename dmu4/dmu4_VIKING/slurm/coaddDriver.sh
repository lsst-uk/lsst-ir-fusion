...
coaddDriver.py ../data --rerun coadd:coaddPhot $Z_VISITS --id filter=VISTA-Z tract=$tract patch=$patch --reuse-outputs-from all --cores=$numCPUs
...
coaddDriver.py ../data --rerun coadd:coaddPhot $Y_VISITS --id filter=VISTA-Y tract=$tract patch=$patch --reuse-outputs-from all --cores=$numCPUs
...
echo $J_VISITS
coaddDriver.py ../data --rerun coadd:coaddPhot $J_VISITS --id filter=VISTA-J tract=$tract patch=$patch --reuse-outputs-from all --cores=$numCPUs
...
coaddDriver.py ../data --rerun coadd:coaddPhot $H_VISITS --id filter=VISTA-H tract=$tract patch=$patch --reuse-outputs-from all --cores=$numCPUs
...
coaddDriver.py ../data --rerun coadd:coaddPhot $KS_VISITS --id filter=VISTA-Ks tract=$tract patch=$patch --reuse-outputs-from all --cores=$numCPUs
