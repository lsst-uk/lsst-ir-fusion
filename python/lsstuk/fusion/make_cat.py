...
def makeCat(tract, patch, BUTLER_LOC,DATA=DATA,writeBandCats=True,writeReducedCat=True,writeSchema=False):
    ...
    for band in allBands:
        ...
        try:
            ...
            if writeBandCats:
                ...
                if writeSchema:
                    measCat.write(
                    DATA+'/{}/example_for_schema_{}_{}_{}_measCat.fits'.format(
                        band,band,tract,patch),
                    overwrite=True
                )
        except:
        ...
        try:
            ...
            if writeBandCats:
                ...
                if writeSchema:
                    forcedCat.write(
                    DATA+'/{}/example_for_schema_{}_{}_{}_forcedCat.fits'.format(
                        band,band,tract,patch),
                    overwrite=True
                )
        except:
